...
plugins=(colored-man git virtualenv autoenv vagrant zsh-syntax-highlighting history-substring-search web-search tmux yum wd docker ssh-agent autosuggestions nvm)
