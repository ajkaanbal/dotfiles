...
gsettings set org.mate.Marco.window-keybindings move-to-workspace-down '<Control><Shift><Alt>j'
gsettings set org.mate.Marco.window-keybindings move-to-workspace-up '<Control><Shift><Alt>k'
